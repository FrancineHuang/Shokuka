  ...
  <div id="ingredients-container" class="flex justify-center">
    <div class="w-9/12 my-10 bg-white border border-gray-200 rounded-lg shadow sm:p-8">
      ...
      <div id="recipe-ingredients">
        ...
        @foreach ($editRecipeData->ingredients as $index => $ingredient)
        <div id="ingredient{{ $index+1 }}" class="my-5 flex items-center justify-center">
          <i class="fas fa-bars text-red-800"></i>
          <input type="text" name="ingredients[{{ $index }}][material]" value="{{ $ingredient->material }}" class="w-2/5 mx-3 my-1 bg-gray-50 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5">
          <input type="text" name="ingredients[{{ $index }}][quantity]" value="{{ $ingredient->quantity }}"class="w-2/5 mx-3 my-1 bg-gray-50 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5">
