...
<x-header-footer :userData="$userData">
  ...
  <div class="flex justify-center">
    ...
    <div class="w-9/12 mt-36 bg-white border border-gray-200 rounded-lg shadow sm:p-8">
      <h5 class="mb-2 text-1xl font-bold text-neutral-900">レシピを編集する</h5>
    ...
    <div class="flex items-center justify-center w-full">
      ...
      <div class="my-3">
        ...
        <input type="text" name="title" value="{{ $editRecipeData->title }}" class="w-11/12 my-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5">
      </div>
      ...
      <div class="my-6">
        ...
        <textarea name="introduction" rows="4" class="w-11/12 my-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5">{{ $editRecipeData->introduction }}</textarea>
      </div>
  ...
  <div class="flex justify-center">
    <div class="w-9/12 my-10 bg-white border border-gray-200 rounded-lg shadow sm:p-8">
      <div class="my-3">
        ...
        <input type="text" name="person" id="base-input" value="{{ $editRecipeData->person }}" class="w-24 my-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5">
      ...
      <div>
        ...
        <div class="my-5 flex items-center justify-center">
          @foreach ($editIngredientData as $ingredient)
          <i class="fas fa-bars text-red-800"></i>
          <input type="text" name="material" value="{{ $ingredient->material }}" class="w-2/5 mx-3 my-1 bg-gray-50 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5">
          <input type="text" name="quantity" value="{{ $ingredient->quantity }}"class="w-2/5 mx-3 my-1 bg-gray-50 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5">
    ...
    <div class="w-9/12 my-5 bg-white border border-gray-200 rounded-lg shadow sm:p-8">
      ...
      <div class="container mx-auto flex px-5 py-10 md:flex-row flex-col items-center">
        <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <textarea name="content" rows="4" class="w-full my-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5">{{ $step->content }}</textarea>
          @endforeach
          <div class="flex justify-center">
  ...
  <div class="flex justify-center">
    <div class="w-9/12 mt-5 mb-10 bg-white border border-gray-200 rounded-lg shadow sm:p-8">
      <div class="my-3">
        ...
        <textarea name="tip" rows="4" class="w-11/12 my-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5">{{ $editRecipeData->tip }}</textarea>
      </div>
    </div>
  </div>
